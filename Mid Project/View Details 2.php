<html>
 ...
 <body style="background-color:rgb(151, 117, 250);">
    ...
    <H1 style="text-align:center;"> Need English Medium Tutor for Standard 5 Student - 4Days/Week </H1>
	<p style="text-align:center;"><b>ID:1002</b></p><br>
	<div id="p1div" style="background-color: white;">
        <p>Posted Date: Feb 27,2021 </p>
        <ul type="square">                               
	        <li><b>Subjects:</b><br> All</li><br>
			<li><b>No of Student: </b><br> 1</li><br>
			<li><b>Student Gender: </b><br> Female</li><br>
			<li><b>Preferred Tutor: </b><br> Female</li><br>
			<li><b>Tutoring Days: </b><br> 4Days/Week</li><br>
	        <li><b>Salary: </b><br> 5000BDT</li><br>
			<li><b>Tutoring Time: </b><br> 5:00PM</li><br>
			<li><b>Location: </b><br> Mohammadpur 15, Dhaka </li><br> 
